...
class GitHubStars extends HTMLElement {
  ...
  async init() {
    ...
    this.logoButton.classList.add("gh-stars-button")
    this.countButton = document.createElement("button")
    this.countButton.innerHTML = "+"
    this.wrapper.appendChild(this.logoButton)
    this.wrapper.appendChild(this.countButton)
